...
export const footerNavData: FooterNavDataType[] = [
  {
    ...
    name: "PRODUCTOS",
    subSeccion: [
      { id: 1, name: "Accesorios de Embalaje", link: "/productos?categoria=accesorios" },
      { id: 2, name: "Airpads", link: "/airpads" },
      { id: 3, name: "Herramientas de Apoyo", link: "/productos?categoria=herramientas" },
      { id: 4, name: "Máquinas Envolvedoras", link: "/envolvedora" },
      { id: 5, name: "Máquinas y Herramientas", link: "/zunchos-herramientas" },
      { id: 6, name: "Sistemas de Embalaje", link: "/productos?categoria=sistemas" },
      { id: 7, name: "Zunchos", link: "/zunchos-herramientas" },
    ],
  },
  {
    id: 2,
