    ...
    <>
        ...
        {swiperData.length > 0 ? (
          <div className="relative">
            ...
            <img
              ...
              className="w-full object-cover lg:hidden h-auto"
            />
            <Swiper
              modules={[Autoplay]}
              spaceBetween={0}
                ...
                <SwiperSlide key={item.id}>
                  <Link to={item.url}>
                    <img
                      src={item.url}
                      alt={item.name}
                      className="w-full aspect-[16/6] object-cover hidden md:block"
                    />
                  </Link>
                </SwiperSlide>
              ))}
            ...
            {[
              ...
              <li key={label} className="group">
                <Link className="flex items-center gap-3 py-1" to={to}>
                  ...
                  <div>
                    <p className="text-xs font-medium text-white/70 tracking-widest">
                      SOLUCIONES
                    </p>
      ...
      <main>
        <section className="relative mt-5">
          <div className="bg-primaryGray px-28 pt-20 lg:pt-12 w-full pb-20 lg:flex xl:gap-16 lg:items-center">
            <div className="md:w-[45%] flex flex-col gap-4 items-center md:items-start">
              <p className="font-light text-sm text-red tracking-[0.2em] uppercase">
                Bienvenido
              </p>
              <div>
                <h2 className="text-3xl font-bold text-textGray leading-tight">
                  FROMM CHILE
                </h2>
            ...
            <div className="prose-content flex flex-col gap-6 justify-center items-center lg:flex-col-reverse lg:w-[50%] mt-8 lg:mt-0">
              <img
                className="rounded-lg shadow-soft w-full object-cover lg:h-auto"
          ...
          <section className="bg-primaryGray mb-20 py-14">
            <div className="max-w-[80%] m-auto flex flex-col gap-6">
              ...
              <p className="text-textGray font-light text-base leading-relaxed">
                Desde la industria del hormigón hasta los centros de
                distribución y desde la madera hasta la industria agrícola.
                Ofrecemos la solución perfecta para su empresa. Sea cual sea el
                mercado en el que esté activo. Nuestros especialistas estarán
                encantados de pensar junto con usted en las soluciones de
                embalaje más ergonómicas.
              </p>
              <CustomSelect />
            </div>
          </section>
          ...
          <section className="mb-20 py-14">
            <div className="prose-content max-w-[75%] m-auto flex flex-col gap-5 lg:max-w-[60%]">
              ...
              <p className="text-textGray font-light text-base leading-relaxed">
                ...
                nuestra sede central en Suiza, nuestros especialistas trabajan
                día y noche para conseguir los mejores productos posibles: para
                asegurar, envolver, rellenar y proteger. Nos aseguramos de que
                sus productos se empaqueten de forma segura. Lo hacemos con
                máquinas y consumibles de alta calidad, plazos de entrega
                rápidos, atención personalizada, bajos costos de embalaje y
                acceso a un servicio de primera.
              </p>
            </div>
          </section>
        </FadeInSection>
          ...
          <section className="px-8 mb-16 md:m-auto md:mt-16 md:mb-12 md:max-w-[900px]">
            <div className="flex flex-col gap-4 text-center mb-10">
              ...
              <p className="font-light text-base text-textGray leading-relaxed max-w-[65ch] mx-auto">
                ...
                consumibles de embalaje de final de línea, con más de 40
                oficinas y más de 30 distribuidores en más de 50 países.
              </p>
            </div>
